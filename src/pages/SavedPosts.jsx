...
function SavedPosts() {
  ...
  useEffect(() => {
    if (currentUser) {
      setSavedPosts(allPosts.length > 0 && allPosts.filter(posts => currentUser.savedPosts.some(saves => saves.postId === posts._id)))
    }
    console.log(savedPosts, "dfffffffffffffffffffffffffff");
