      ...
      <nav className="navbar fixed-top " style={{ background: "#fff" }}>
        <div className="container">
          ...
          <div className="d-flex align-items-center">
            ...
            <Link to={"/editprofile"} className="d-none d-md-block">
              <img
                src={
                  currentUser
                ...
                <div style={{ position: "fixed", zIndex: "1" }}>
                    ...
                    <div className="d-flex align-items-center mb-3">
                      <img
                        src={
                          currentUser
                            ? `${BASE_URL}/upload/${currentUser.image}`
                            : "https://social-media-noko.vercel.app/images/profile-1.jpg"
                        }
                        alt=""
                        style={{
                          width: "80px",
                      ...
                      <div className="ms-3 d-flex align-items-center flex-column w-100">
                        ...
                        <div className="d-flex justify-content-evenly w-100">
                          ...
                          >
                            <div>
                              <h5
                                className="text-center mb-0 me-1"
                                style={{
                                  fontSize:
                                    "clamp(0.875rem, 0.4375rem + 1vw, 1.25rem)",
                                }}
                              >
                                Followers
                              </h5>
                          ...
                          >
                            <div>
                              <h5
                                className="text-center mb-0 ms-1"
                                style={{
                                  fontSize:
                                    "clamp(0.875rem, 0.4375rem + 1vw, 1.25rem)",
                                }}
                  ...
                  >
                    <h6
                      className="mb-0"
                      style={{
                        fontSize: "clamp(0.75rem, 0.3125rem + 1vw, 1.125rem)",
                      }}
                    >
            ...
            >
              ...
              <Offcanvas.Body>
                <div style={{ backgroundColor: "#fff", borderRadius: "10px" }}>
                  ...
                  >
                    <div
                      className="px-3 py-3 lists"
                      style={{ borderBottom: "1px solid #b3a6e480" }}
                    >
                      <h5>Home</h5>
                    </div>
                  </Link>
                  ...
                  >
                    <div
                      className="px-3 py-3 lists d-flex justify-content-between"
                      style={{ borderBottom: "1px solid #b3a6e480" }}
                    >
                      <h5>Saved Posts</h5>
                      <h5>0</h5>
                  ...
                  <div
                    className="px-3 py-3 lists"
                    style={{
                      borderBottom: "1px solid #b3a6e480",
                      color: "#fff",
