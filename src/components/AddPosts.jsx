...
function AddPosts() {
    ...
    const [postData, setPostData] = useState({
        caption: "", dateOfPosted: new Date(), username: "", image: ""
    })
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                <Form.Group as={Col} md="12" controlId="validationCustom01">
                    <label htmlFor="addpost" className='w-100 d-flex justify-content-center'>
                        <input type="file" id='addpost' style={{ display: "none" }} className='w-100 ' required onChange={(e) => { setPostData({ ...postData, image: e.target.files[0] }) }} />
                        <img src={preview ? preview : addPostIcon} alt="" className='img-fluid' style={{ height: "300px", borderRadius: "10px" }} />
                    </label>
                </Form.Group>
                ...
                <div className="d-flex justify-content-center w-100">
                    <Button type="submit" style={{ border: "none", backgroundColor: "#6b4ce6", borderRadius: "15px", color: "#fff" }} className='py-2 px-3' disabled={!user}>Post</Button>
                </div>
            </Form>
        </div>
    )
